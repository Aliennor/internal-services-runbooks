...
- intended tag: `aliennor/internal-services-katilim-failover-docs-20260326:0.1.0`
- pushed digest: `sha256:d43f9f36d4c5fbccb645cecfa31dfc2de49008fdf43b7fcf0a3e6a33139c6ed4`
...
```bash
docker pull aliennor/internal-services-katilim-failover-docs-20260326:0.1.0
```
...
```bash
docker run --rm -v /opt/orbina/architecture:/output aliennor/internal-services-katilim-failover-docs-20260326:0.1.0 /output
```
